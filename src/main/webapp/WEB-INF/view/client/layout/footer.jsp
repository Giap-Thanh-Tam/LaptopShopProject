                    ...
                    <div class="container py-5">
                        <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                            <div class="row g-4">
                                <div class="col-lg-3">
                                    <a href="#">
                                        <h2 class="text-primary mb-0">Cửa hàng Laptop</h2>
                                        <p class="text-secondary mb-0">Thanh Tâm</p>
                                    </a>
                                </div>
                                <!-- <div class="col-lg-6">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer-item">
                                    ...
                                    <p>Author: Thanh Tâm</p>
                                    <p>Website: <a href="https://gttam.space/">gttam.space</a></p>
