                                ...
                                <div class="col-md-12 col-lg-6 5">
                                    <div class="table-responsive">
                                        <div class="bg-light rounded">
                                            <div class="p-4">
                                                <h2 class="display-6 mb-4">Thông Tin <span class="fw-normal">Thanh
                                                        Toán</span>
                                                </h2>
                                            ...
                                            <form:form action="/confirm-checkout" method="post" modelAtriibute="cart">
                                                ...
                                                <a href="/checkout"> <button
                                                        ...
                                                        type="button">Xác Nhận Thanh Toán</button></a>
                                                <form:form />
                                        </div>
                                    </div>
