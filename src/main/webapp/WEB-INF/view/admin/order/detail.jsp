                        ...
                        <main>
                            <div class="container-fluid px-4">
                                ...
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item active"> <a href="/admin">Order</a></li>
                                ...
                                <div class="mt-5">
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                                        ...
                                                        <c:forEach var="orderDetail" items="${orderDetails}">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p class="mb-0 mt-4">
                                                                        <a href="/product/${orderDetail.product.id}">${orderDetail.product.name}
                                                                        </a>
                                                                    </p>
                                                                </td>
                                                                <td>
                                            ...
                                            <div> <a href="/admin/order" class="btn btn-success"> Back</a></div>
